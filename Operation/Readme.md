...
Download youtube_bot.py and put it into the folder you created during the deployment step. Then you can activate the bot using the following commands.
...
```console
$ sudo docker run -it videobot:1 youtube_bot.py hacking 5
```
